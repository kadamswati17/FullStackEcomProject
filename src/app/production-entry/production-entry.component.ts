...
import { ProductionService } from '../admin/service/ProductionService';
...
export class ProductionEntryComponent implements OnInit {
  ...
  loadCurrentUserRole() {
    ...
    const userStr = sessionStorage.getItem('ecom-user');
  ...
  canEditDelete(): boolean {
    ...
    console.log('CHECK ROLE FOR ACTION:', this.currentUserRole);
